...
const TopHeader: React.FC = () => {
  return (
    <header className="h-16 flex items-center justify-between px-8 bg-background border-b sticky top-0 z-10">
      <div>
      ...
      <div className="flex items-center gap-6">
        <Select defaultValue="2024">
          <SelectTrigger className="w-[180px] bg-card focus:ring-primary">
